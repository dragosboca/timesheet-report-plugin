...
export class ObsidianTemplateManager {
...
*Report generated on {{GENERATION_DATE}} using Obsidian Timesheet Report Plugin*`;
  ...
  private getSampleTemplateContent(): string {
    return `# {{PROJECT_NAME}} - {{MONTH_YEAR}} Report
...
## Executive Summary
During {{REPORT_PERIOD}}, a total of **{{MONTH_HOURS}} hours** were logged for this project.
...
---
*This report was generated automatically using the Obsidian Timesheet Report Plugin.*`;
  }
  ...
  getAvailablePlaceholders(): Array<{ name: string; description: string }> {
    return [
      ...
      { name: '{{REPORT_PERIOD}}', description: 'Same as MONTH_YEAR' },
      { name: '{{MONTH_HOURS}}', description: 'Total hours worked in the month' },
      { name: '{{REMAINING_HOURS}}', description: 'Remaining budget hours (if applicable)' },
      { name: '{{TOTAL_VALUE}}', description: 'Total monetary value of hours worked' },
